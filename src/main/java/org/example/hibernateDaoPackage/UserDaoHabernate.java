...
public class UserDaoHabernate implements UserDao {

        public UserDaoHabernate() {
...
//                EntityManager entityManager = HibernateConnector.entityManager().createEntityManager();
//
